...
/**
 * Filtres GET pour la liste des candidats.
 */
final class CandidateListFiltersForm extends FormBase {

  public function getFormId(): string {
    return 'bongolava_admin_candidate_list_filters';
  }

  public function buildForm(array $form, FormStateInterface $form_state, array $filters = []): array {
    $form['#method'] = 'get';
    $form['#action'] = Url::fromRoute('bongolava_admin.candidates_list')->toString();
    $form['#token'] = FALSE;
    ...
    $form['actions']['reset'] = [
      ...
      '#url' => Url::fromRoute('bongolava_admin.candidates_list'),
